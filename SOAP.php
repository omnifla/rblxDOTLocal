...
"Arguments": ["https://localhost/asset/?id=' . $placeId . '", "PNG", 1280, 720, "https://localhost", ' . $placeId . ']
},
"Arguments": {
...
"BaseUrl": "localhost",
"MatchmakingContextId": 1,
"Arguments": ["https://localhost", "https://localhost/v1.1/avatar-fetch?userId=' . $userId . '&placeId=0", "PNG", 768, 768]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"BaseUrl": "localhost",
"MatchmakingContextId": 1,
"Arguments": ["https://localhost", "https://localhost/v1.1/avatar-fetch?userId=' . $userId . '&placeId=1", "PNG", 768, 768, true, 40, 100, 0, 0]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"BaseUrl": "localhost",
"MatchmakingContextId": 1,
"Arguments": ["https://localhost", "https://localhost/v1.1/avatar-fetch?userId=' . $userId . '&placeId=0", "OBJ", 768, 768]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"BaseUrl": "localhost",
"MatchmakingContextId": 1,
"Arguments": ["https://localhost/asset/?id=' . $assetId . '","https://localhost/","OBJ", 720, 720, "https://localhost/asset/?id=8246626421", ""]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"BaseUrl": "localhost",
"MatchmakingContextId": 1,
"Arguments": ["https://localhost/asset/?id=' . $assetId . '","OBJ", 720, 720, "https://localhost/", 8246626421]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"BaseUrl": "localhost",
"MatchmakingContextId": 1,
"Arguments": ["https://localhost/asset/?id=' . $assetId . '","OBJ", 720, 720, "https://localhost/"]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"BaseUrl": "localhost",
"MatchmakingContextId": 1,
"Arguments": ["https://localhost/asset/?id=' . $assetId . '","https://localhost/","PNG", 720, 720, "https://localhost/asset/?id=235400037", ""]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"BaseUrl": "localhost",
"MatchmakingContextId": 1,
"Arguments": ["https://localhost/asset/?id=' . $assetId . '","PNG", 720, 720, "https://localhost/", 235400037]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"BaseUrl": "localhost",
"MatchmakingContextId": 1,
"Arguments": ["https://localhost/asset/?id=' . $assetId . '","PNG", 720, 720, "https://localhost/"]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"JobId":"' . $JobId . '",
"PreferredPort":' . $gamerandomport . ',
"PlaceFetchUrl":"https://localhost/asset/?id=' . $placeId . '"
},
"Arguments":{}
}
';
...
"BaseUrl": "localhost",
"MatchmakingContextId": 1,
"Arguments": ["https://localhost", "https://localhost/v1.1/avatar-fetch?userId=' . $userId . '&placeId=0", "PNG", ' . $x . ', ' . $y . ']
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
