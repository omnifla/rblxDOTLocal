...
<div id="catalog" data-empty-search-enabled="true" style="font-size: 12px;">
  <div class="header" style="height:60px;">
    <div style="float:left;">
      <h1><a href="https://localhost/catalog" id="CatalogLink">Catalog</a></h1>
    </div>
  ...
  <div class="left-nav-menu divider-right">
      ...
      <ul id="dropdownUl" class="clearfix">
        <li class="subcategories" data-delay="never">
          ...
          <ul class="slideOut" style="top:-1px;">
            ...
            <li><a href="#category=featured" class="assetTypeFilter" data-types="0" data-category="0">All Featured
                Items</a></li>
            <li><a href="#category=featured" class="assetTypeFilter" data-types="9" data-category="0">Featured Hats</a>
            </li>
            <li><a href="#category=featured" class="assetTypeFilter" data-types="5" data-category="0">Featured Gear</a>
            </li>
            <li><a href="#category=featured" class="assetTypeFilter" data-types="10" data-category="0">Featured
                Faces</a></li>
            <li><a href="#category=featured" class="assetTypeFilter" data-types="11" data-category="0">Featured
                Packages</a></li>
          </ul>
        </li>
        <li class="subcategories"><a href="#category=collectibles" class="assetTypeFilter collectiblesLink"
            data-category="2">Collectibles</a>
          <ul class="slideOut" style="top:-32px;">
            <li class="slideHeader"><span>Collectible Types</span></li>
            <li><a href="#category=collectibles" class="assetTypeFilter" data-types="2" data-category="2">All
                Collectibles</a></li>
            <li><a href="#category=collectibles" class="assetTypeFilter" data-types="10" data-category="2">Collectible
                Faces</a></li>
            <li><a href="#category=collectibles" class="assetTypeFilter" data-types="9" data-category="2">Collectible
                Hats</a></li>
            <li><a href="#category=collectibles" class="assetTypeFilter" data-types="5" data-category="2">Collectible
                Gear</a></li>
          </ul>
        </li>
        ...
        <li class="subcategories"><a href="#category=bodyparts" class="assetTypeFilter" data-category="4">Body Parts</a>
          <ul class="slideOut" style="top:-128px;">
            ...
            <li><a href="#category=bodyparts" class="assetTypeFilter" data-types="4" data-category="4">All Body
                Parts</a></li>
            ...
            <li><a href="#category=bodyparts" class="assetTypeFilter" data-types="11" data-category="4">Packages</a>
            </li>
          </ul>
        </li>
        <li class="subcategories"><a href="#category=gear" class="assetTypeFilter" data-category="5">Gear</a>
          <ul class="slideOut" style="top:-159px; width:auto;" style="border-right:0px;">
            <div>
              ...
              <li><a href="#geartype=Melee Weapon" class="gearFilter" data-category="5" data-types="1">Melee Weapon</a>
              </li>
              <li><a href="#geartype=Ranged Weapon" class="gearFilter" data-category="5" data-types="2">Ranged
                  Weapon</a></li>
              ...
              <li><a href="#geartype=Navigation Enhancer" class="gearFilter" data-category="5" data-types="5">Navigation
                  Enhancer</a></li>
              <li><a href="#geartype=Musical Instrument" class="gearFilter" data-category="5" data-types="6">Musical
                  Instrument</a></li>
              <li><a href="#geartype=Social Item" class="gearFilter" data-category="5" data-types="7">Social Item</a>
              </li>
              <li><a href="#geartype=Building Tool" class="gearFilter" data-category="5" data-types="8">Building
                  Tool</a></li>
              <li><a href="#geartype=Personal Transport" class="gearFilter" data-category="5" data-types="9">Personal
                  Transport</a></li>
            </div>
          </ul>
        </li>
    ...
    <div style="margin-left:5px">
      <?php if ($_GET['Category'] == 1) { ?>
        ...
        <ul>
          <li><a href="#category=All Categories" class="assetTypeFilter selected" data-keepfilters="true"
              data-category="1">All Categories</a></li>
          <li><a href="#category=Body Parts" class="assetTypeFilter" data-keepfilters="true" data-category="4">Body
              Parts</a></li>
          <li><a href="#category=Clothing" class="assetTypeFilter" data-keepfilters="true" data-category="3">Clothing</a>
          </li>
          <li><a href="#category=Collectibles" class="assetTypeFilter" data-keepfilters="true"
              data-category="2">Collectibles</a></li>
          <li><a href="#category=Featured" class="assetTypeFilter" data-keepfilters="true" data-category="0">Featured</a>
          </li>
          <li><a href="#category=Gear" class="assetTypeFilter" data-keepfilters="true" data-category="5">Gear</a></li>
          <li><a href="#category=Accessories" class="assetTypeFilter" data-keepfilters="true"
              data-category="11">Accessories</a></li>
          <li><a href="#category=Avatar Animations" class="assetTypeFilter" data-keepfilters="true"
              data-category="12">Avatar Animations</a></li>
        </ul>
      <? } ?>
      <?php if ($_GET['Category'] == 3) { ?>
        <div class="filter-title">Clothing Type</div>
        <ul>
          <li><a href="#subcategory=All Clothing"
              class="assetTypeFilter <? if ($_GET['Subcategory'] == 3) {
                echo ' selected';
              } ?>" data-types="3">All Clothing</a>
          </li>
          <li><a href="#subcategory=Hats" class="assetTypeFilter <? if ($_GET['Subcategory'] == 9) {
            echo ' selected';
          } ?>"
              data-types="9">Hats</a></li>
          <li><a href="#subcategory=Shirts" class="assetTypeFilter <? if ($_GET['Subcategory'] == 12) {
            echo ' selected';
          } ?>"
              data-types="12">Shirts</a></li>
          <li><a href="#subcategory=T-Shirts" class="assetTypeFilter <? if ($_GET['Subcategory'] == 13) {
            echo ' selected';
          } ?>"
              data-types="13">T-Shirts</a></li>
          <li><a href="#subcategory=Pants" class="assetTypeFilter <? if ($_GET['Subcategory'] == 14) {
            echo ' selected';
          } ?>"
              data-types="14">Pants</a></li>
          <li><a href="#subcategory=Packages" class="assetTypeFilter <? if ($_GET['Subcategory'] == 11) {
            echo ' selected';
          } ?>"
              data-types="11">Packages</a></li>
        </ul>
      <? } ?>
      <?php if ($_GET['Category'] == 4) { ?>
        <div class="filter-title">Body Parts Type</div>
        <ul>
          <li><a href="#subcategory=All Body Parts"
              class="assetTypeFilter <? if ($_GET['Subcategory'] == 4) {
                echo ' selected';
              } ?>" data-types="4">All Body
              Parts</a></li>
          <li><a href="#subcategory=Heads" class="assetTypeFilter <? if ($_GET['Subcategory'] == 15) {
            echo ' selected';
          } ?>"
              data-types="15">Heads</a></li>
          <li><a href="#subcategory=Faces" class="assetTypeFilter <? if ($_GET['Subcategory'] == 10) {
            echo ' selected';
          } ?>"
              data-types="10">Faces</a></li>
          <li><a href="#subcategory=Packages" class="assetTypeFilter <? if ($_GET['Subcategory'] == 11) {
            echo ' selected';
          } ?>"
              data-types="11">Packages</a></li>
      ...
      <?php if ($_GET['Category'] == 5) { ?>
        ...
        <ul>
          <li>
            <a href="#geartype=All Gear" class="gearFilter <? if ($_GET['Gears'] == 0) {
              echo ' selected';
            } ?>"
              data-types="All">All Gear</a>
          </li>
          <li>
            <a href="#geartype=Building" class="gearFilter <? if ($_GET['Gears'] == 8) {
              echo ' selected';
            } ?>"
              data-types="8">Building</a>
          </li>
          <li>
            <a href="#geartype=Explosive" class="gearFilter <? if ($_GET['Gears'] == 3) {
              echo ' selected';
            } ?>"
              data-types="3">Explosive</a>
          </li>
          <li>
            <a href="#geartype=Melee" class="gearFilter <? if ($_GET['Gears'] == 1) {
              echo ' selected';
            } ?>"
              data-types="1">Melee</a>
          </li>
          <li>
            <a href="#geartype=Musical" class="gearFilter <? if ($_GET['Gears'] == 6) {
              echo ' selected';
            } ?>"
              data-types="6">Musical</a>
          </li>
          <li>
            <a href="#geartype=Navigation" class="gearFilter <? if ($_GET['Gears'] == 5) {
              echo ' selected';
            } ?>"
              data-types="5">Navigation</a>
          </li>
          <li>
            <a href="#geartype=Power Up" class="gearFilter <? if ($_GET['Gears'] == 4) {
              echo ' selected';
            } ?>"
              data-types="4">Power Up</a>
          </li>
          <li>
            <a href="#geartype=Ranged" class="gearFilter <? if ($_GET['Gears'] == 2) {
              echo ' selected';
            } ?>"
              data-types="2">Ranged</a>
          </li>
          <li>
            <a href="#geartype=Social" class="gearFilter <? if ($_GET['Gears'] == 7) {
              echo ' selected';
            } ?>"
              data-types="7">Social</a>
          </li>
          <li>
            <a href="#geartype=Transport" class="gearFilter <? if ($_GET['Gears'] == 9) {
              echo ' selected';
            } ?>"
              data-types="9">Transport</a>
          </li>
        </ul>
      <? } ?>
    ...
    <div id="legend" class="divider-top">
      ...
      <div id="legendcontent" style="overflow: hidden; ">
        <img src="https://localhost/img/4fc3a98692c7ea4d17207f1630885f68.png" style="margin-left: -13px" />
        <div class="legendText"><b>Builders Club Only</b><br />
          Only purchasable by Builders Club members.</div>
        <img src="https://localhost/img/793dc1fd7562307165231ca2b960b19a.png" style="margin-left: -13px" />
        ...
        <img src="https://localhost/img/d649b9c54a08dcfa76131d123e7d8acc.png" style="margin-left: -13px" />
        <div class="legendText"><b>Limited Unique Items</b><br />
          A limited supply originally sold by ROBLOX. Each unit is labeled with a serial number. Once sold out, owners
          can re-sell them to other users.
        </div>
      </div>
    </div>
  </div>
  <div class="right-content divider-left">
    <a href="#breadcrumbs=category" class="breadCrumbFilter bolded"
      data-filter="category"><? if ($_GET['Category'] == 3) {
        echo "Clothing";
      }
      if ($_GET['Category'] == 4) {
        echo "Body Parts";
    ...
    &#187; <a href="#breadcrumbs=subcategory" class="breadCrumbFilter selected"
      data-filter="subcategory"><? if ($_GET['Category'] == 3 && $_GET['Subcategory'] == 9) {
        echo "Hats";
      }
      if ($_GET['Category'] == 3 && $_GET['Subcategory'] == 11) {
        echo "Packages";
      }
      if ($_GET['Category'] == 4 && $_GET['Subcategory'] == 11) {
        echo "Packages";
      }
      if ($_GET['Category'] == 4 && $_GET['Subcategory'] == 10) {
        echo "Faces";
      }
      if ($_GET['Category'] == 4 && $_GET['Subcategory'] == 15) {
        echo "Heads";
      }
      if ($_GET['Category'] == 4 && $_GET['Subcategory'] == 4) {
        echo "All Body Parts";
      }
      if ($_GET['Category'] == 1) {
        echo "All Categories";
      }
      if ($_GET['Category'] == 3 && $_GET['Subcategory'] == 12) {
        echo "Shirts";
      }
      if ($_GET['Category'] == 3 && $_GET['Subcategory'] == 14) {
        echo "Pants";
      }
      if ($_GET['Category'] == 3 && $_GET['Subcategory'] == 13) {
        echo "T-Shirts";
      }
      if ($_GET['Category'] == 5 && $_GET['Gears'] == 8) {
        echo "Building";
      }
      if ($_GET['Category'] == 5 && $_GET['Gears'] == 3) {
        echo "Explosive";
      }
      if ($_GET['Category'] == 5 && $_GET['Gears'] == 1) {
        echo "Melee";
      }
      if ($_GET['Category'] == 5 && $_GET['Gears'] == 6) {
        echo "Musical";
      }
      if ($_GET['Category'] == 5 && $_GET['Gears'] == 5) {
        echo "Navigation";
      }
      if ($_GET['Category'] == 5 && $_GET['Gears'] == 4) {
        echo "Power Up";
      }
      if ($_GET['Category'] == 5 && $_GET['Gears'] == 2) {
        echo "Ranged";
      }
      if ($_GET['Category'] == 5 && $_GET['Gears'] == 7) {
        echo "Social";
      }
      if ($_GET['Category'] == 5 && $_GET['Gears'] == 9) {
        echo "Transport";
      } ?></a>
    <div id="secondRow">
            ...
            <div class="CatalogItemInner BigInner">
              <div class="roblox-item-image image-large" data-item-id="<?= $id; ?>" data-image-size="large">
                <div class="item-image-wrapper">
                  <a href="https://localhost/library/?id=<?= $id; ?>">
                    <img title="<? echo NoXSSPlz($iname); ?>" alt="<? echo NoXSSPlz($iname); ?>" class="original-image "
                      src="https://localhost/model-thumbnails?assetId=<?= $id; ?>" loading="lazy" />
                  </a>
                </div>
              </div>
              <div id="textDisplay">
                <div class="CatalogItemName notranslate"><a class="name notranslate"
                    href="https://localhost/library/?id=<?= $id; ?>"
                    title="<? echo NoXSSPlz($iname); ?>"><? echo NoXSSPlz($iname); ?></a></div>
                <div class="robux-price"><span class="robux notranslate"><? echo $pricerob; ?></span></div>
              </div>
              <div class="CatalogHoverContent">
                <div><span class="CatalogItemInfoLabel">Creator:</span> <span class="HoverInfo notranslate"><a
                      href="https://localhost/users/<?= $cid; ?>/profile"><? echo NoXSSPlz($cname); ?></a></span></div>
                <div><span class="CatalogItemInfoLabel">Updated:</span><span
                    class="HoverInfo"><? echo NoXSSPlz($updated); ?></span></div>
                <div><span class="CatalogItemInfoLabel">Sales:</span> <span
                    class="HoverInfo notranslate"><? echo NoXSSPlz($sales); ?></span></div>
                <div><span class="CatalogItemInfoLabel">Favorited:</span> <span
                    class="HoverInfo"><? echo NoXSSPlz($favorite); ?> times</span></div>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="PurchaseModalBody">
    <div class="PurchaseModalMessage">
      ...
      <div class="PurchaseModalMessageText">
        <span>
          <img src="https://localhost/img/a2da4a35291d2c85df85240e4cf03772.jpg" />
        </span>
        <br />
        To add gear to your game, find an item in the catalog and click the "Add to Game" button. The item will
        automatically be allowed in game, and you'll receive a commission on every copy sold from your game page. (You
        can only add gear that's for sale.)
      </div>
    </div>
