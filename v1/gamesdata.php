...
if (strpos($url, "game-thumbnails") !== false) {
    ...
    foreach ($placeIds as $placeId) {
        ...
        $gameItem = [
            "final" => true,
            "url" => "https://localhost/v1/games/game-thumbnail?imageToken={$placeId}&height=50&width=50",
            "cdnUrl" => "https://localhost/img/games/{$gameid}s.png",
            "retryToken" => null,
            "universeId" => $gameid,
            "placeId" => $gameid
        ];
    ...
    header("Location: https://localhost" . $imageToken);
    exit();
    ...
    foreach ($placeIds as $placeId) {
        $gameItem = [
            ...
            "state" => "Completed",
            "imageUrl" => "https://localhost" . getPlaceIcon($con, $placeId),
        ];
...
LIMIT :start,:limit");
    ...
    foreach ($placeIds as $placeId) {
        ...
        $gameItem = [
            ...
            "url" => "https://localhost/games/{$game['id']}/",
            "builder" => $creatorname,
