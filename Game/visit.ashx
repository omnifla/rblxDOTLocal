...
<<<<<<< HEAD
	player.CharacterAppearance = "http://localhost/v1.1/avatar-fetch?userId=1&placeId=<?=$placeId;?>"
=======
...
<<<<<<< HEAD
		visit:SetPing("http://localhost/Game/ClientPresence.ashx?version=old&PlaceID=<?=$placeId;?>", 20)
=======
...
if success then
	...
	if not inStudio then
		if false then
<<<<<<< HEAD
			game:HttpPost("https://localhost/Error/Lua.ashx", "Visit.lua: " .. err)
=======
