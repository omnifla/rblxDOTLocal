...
<div id="uploadProgressBar" data-upload-url="http://localhost/Data/Upload.ashx?assetid=<?=$placeId;?>&type=Model&ispublic=False" data-previous-url="http://localhost/ide/publish/newmodel" data-newupload="True" data-assetid="<?=$placeId;?>" data-isplace="False" data-ispackage="False">
...
<input class="form-text-box" id="gameLink" name="gameLink" type="text" value="http://localhost/library/?id=<?=$placeId;?>" />
</div>
</div>
<script type="text/javascript">
