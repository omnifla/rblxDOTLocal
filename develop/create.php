...
<link onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' rel='stylesheet' href='https://localhost/css/developcreate.css' />
<script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='header' type='text/javascript' src='https://localhost/js/a65ed7da4b382cd9d6511908a5fad38e.js'></script>
...
<script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='base' type='text/javascript' src='https://localhost/js/465ab944465b37e1236f853c78b1a9c9.js'></script>
...
<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="CoreUtilities" data-bundle-source="Main" src="https://localhost/js/1fb8b744dd67c1394e4b32036254dea94cc76823725f80dcb366ce43d3ca8af1.js"></script>
<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="CoreRobloxUtilities" data-bundle-source="Main" src="https://localhost/js/1e53579ca711cb6cef72a952da7bc955115a220feba4b523d50daf2f3324171f.js"></script>
...
<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="ReactStyleGuide" data-bundle-source="Main" src="https://localhost/js/5301e4bf0d04097eecd473d709fc8b566b5b2223d61e923fc643996c86cabf38.js"></script>
...
<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="AngularJsUtilities" data-bundle-source="Main" src="https://localhost/js/1c7ab1e84db2ce066ae33c0fd3bb9bcf375ad7b9e4d4bcdfc8dff8fa60cb59f8.js"></script>
...
<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="Thumbnails" data-bundle-source="Main" src="https://localhost/js/ca6836e875140765f70de8ce77eeb48ad4702890af0a407eda2fa5be9ad1e50b.js"></script>
<script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='page' type='text/javascript' src='https://localhost/js/af094bddc77ceb5f9e5c8e1d66c948ad.js'></script>
...
<h1>Create Place</h1>
<div data-isBC="false">
<form id="placeForm" method="POST" action="https://localhost/develop/create">
...
<a href="" class="game-image" data-retry-url="" ><img class='' src='https://localhost/img/baseplate.png'/></a>
...
<script type="text/javascript">
var Roblox = Roblox || {};
Roblox.AccessData = {"isDevelopSiteForVipServersEnabled":true,"vipServerConfigurationLink":"https://localhost/v1/universes//configuration/vip-servers","privateServersAllowed":true};
</script>
...
<option>99</option>
<option>100</option>
</select> <img class="TipsyImg tooltip-bottom h2-tooltip number-of-players-max-tooltip" src="https://localhost/img/65cb6e4009a00247ca02800047aafb87.png" data-toggle="tooltip" title="The maximum number of people allowed in one instance of the game." />
...
<label class="checkboxListItem"> <input checked="checked" data-val="true" data-val-required="The Server Fill: field is required." id="AutomaticFriendSlots" name="SocialSlotType" type="radio" value="Automatic" /> <span class="checkboxListItem">Roblox optimizes server fill for me</span> <img class="TipsyImg tooltip-bottom h2-tooltip" src="https://localhost/img/65cb6e4009a00247ca02800047aafb87.png" data-toggle="tooltip" title="Roblox will fill your server to optimize for the best social game." /> </label>
...
<label class="checkboxListItem"> <input id="CustomFriendSlots" name="SocialSlotType" type="radio" value="Custom" /> <span class="checkboxListItem">Customize how many server slots to reserve</span> <img class="TipsyImg tooltip-bottom h2-tooltip" src="https://localhost/img/65cb6e4009a00247ca02800047aafb87.png" data-toggle="tooltip" title="Friends are more likely to join people in your game if you reserve more slots." /> </label>
...
<span>
Allow Private Servers <a href="https://localhost/en-us/articles/Creating-a-VIP-Server-on-Roblox" target="_blank">
<img class="h2-tooltip private-server-tooltip" src="https://localhost/img/65cb6e4009a00247ca02800047aafb87.png" alt="Click here to learn about private servers" data-toggle="tooltip" title="Click here to learn about private servers" />
</a>
</span>
</label>
...
<img src="https://localhost/img/e0802687d8357fbc484a75914e4447dc.gif" alt="Loading private server statistics...">
...
Marketplace Fee <img class="h2-tooltip private-server-tooltip" src="https://localhost/img/65cb6e4009a00247ca02800047aafb87.png" data-toggle="tooltip" data-toggle-mobile="true" data-original-title="30% - minimum 1" />:<br />
</div>
...
Roblox.PlayerAccess.AlertImageUrl = 'https://localhost/img/cbb24e0c0f1fb97381a065bd1e056fcb.png';
Roblox.PlayerAccess.tailLeftImage = 'https://localhost/img/77c4414271016f8257c136305b7888b4.png';
</script>
</div>
<div class="tab-content" id="advancedsettings_tab">
<div class="headline">
<h2>Gear Permissions</h2>
<img class="TipsyImg tooltip-bottom h2-tooltip" data-toggle="tooltip" title="The type of gear allowed in your game. By default the same genre of gear is allowed as the genre of the game." height="13" width="12" src="https://localhost/img/65cb6e4009a00247ca02800047aafb87.png" alt="The type of gear allowed in your game. By default the same genre of gear is allowed as the genre of the game." />
</div>
...
<fieldset>
By checking this box, <b>you are granting every other user of Roblox the right to use</b> (in various ways) the content you are now sharing. <b>If you do not want to grant this right, please do not check this box</b>. For more information about sharing content, please review the Roblox <a class='text-link' href='https://localhost/info/terms' class='rbx-link'>Terms of Use</a>.
<label id="copyLock">
...
<p class="processing-indicator"><img src='https://localhost/img/ec4e85b0c4396cf753a06fade0a8d8af.gif' alt="Creating place..." /></p>
...
<script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='pageEnd' type='text/javascript' src='https://localhost/js/0b588f67c108ffe7031f4c5e429514a6.js'></script>
</body>
</html>
