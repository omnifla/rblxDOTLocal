...
<div class="container-main">
    <noscript>
        <div&gt;<div class="alert-info" role="alert" &gt;Please enable Javascript to use all the features on this
            site.</div&gt;</div&gt;</noscript>
            <?php
                            ...
                            <div class="nav-content-inner">
                                <div id="Container">
                                    ...
                                    <div id="Body" class="simple-body">
                                        <div
                                            style="border: solid 1px #000; margin: 0 auto; padding: 30px; max-width: 500px;">
                                            <h2 style="text-align: center;">Warning</h2>
                                            <p>Our content monitors have determined that your behavior at Limbo has been in
                                                violation of our Terms of Service. </p>
                                            <div id="ctl00_cphRoblox_ModeratorNotePanel">
                                                <p>Moderator Note: <span style="font-weight: bold"><span
                                                            id="ctl00_cphRoblox_Label4" mode="Encode"><?php echo $banreason ?></span></span></p>
                                            </div>
...
';
                                            ...
                                            <p style="text-align: center;">
                                                <?php if ($daysAway <= 0) {
                                                    echo '<a href="/banned/unban.php">Activate</a>';
                                                } ?>
                                            </p>
                                        </div>
                                    </div>
