...
<body>
    <video id="bg" playsinline autoplay muted loop
        style="position: fixed; left: 0; right: 0; bottom: 0; min-width: 100%; min-height: 100%; filter: blur(0.4em); object-fit: fit;">
        <source
            src="https://cdn.discordapp.com/attachments/1113511026634276894/1122862712565796884/ezgif.com-resize.mp4"
            type="video/mp4">
    </video>
