...
if (!isset($_GET['tab'])) {
    header("Location: https://localhost/admi/?tab=Moderation&item=Users");
    exit();
}
            ...
            <div id="RepositionBody">
                <div id="Body" class="body-width">
                    ...
                    <div class="col-xs-12 rbx-tabs-horizontal">
                        <ul id="horizontal-tabs" class="nav nav-tabs" role="tablist">
                            <li id="tab-Moderation"
                                class="rbx-tab tab-Moderation <?php if ($_GET['tab'] === 'Moderation') {
                                    echo 'active';
                                } ?>"
                                onclick="location.replace('https://localhost/admi/?tab=Moderation&item=Users')">
                                <a class="rbx-tab-heading" href="https://localhost/admi/?tab=Moderation&item=Games">
                                    <span class="text-lead">Moderation</span>
                                </a>
                            </li>
                            <?php if ($SuperAdmin === 1) { ?>
                                <li id="tab-GameServers"
                                    class="rbx-tab tab-GameServers <?php if ($_GET['tab'] === 'GameServers') {
                                        echo 'active';
                                    } ?>"
                                    onclick="location.replace('https://localhost/admi/?tab=GameServers&item=GameJobs')">
                                    <a class="rbx-tab-heading" href="https://localhost/admi/?tab=GameServers&item=GameJobs">
                                        <span class="text-lead">Game Servers</span>
                                    </a>
                                </li>
                                <li id="tab-leaderboards"
                                    class="rbx-tab tab-control <?php if ($_GET['tab'] === 'WebsiteControl') {
                                        echo 'active';
                                    } ?>"
                                    onclick="location.replace('https://localhost/admi/?tab=WebsiteControl&item=Alerts')">
                                    <a class="rbx-tab-heading"
                                        href="https://localhost/admi/?tab=WebsiteControl&item=Alerts">
                                        <span class="text-lead">Website Control</span>
                                    </a>
                                </li>
                            <? } ?>
                            <li id="tab-statistics"
                                class="rbx-tab tab-statistics <?php if ($_GET['tab'] === 'Statistics') {
                                    echo 'active';
                                } ?>"
                                onclick="location.replace('https://localhost/admi/?tab=Statistics&item=Users')">
                                <a class="rbx-tab-heading" href="https://localhost/admi/?tab=Statistics&item=Users">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="menu-area divider-right">
                                            <a href="https://localhost/admi/?tab=Moderation&item=Users"
                                                class="tab-item <?php if ($_GET['item'] === 'Users') {
                                                    echo 'tab-item-selected';
                                                } ?>">Users</a>
                                            <a href="https://localhost/admi/?tab=Moderation&item=Games"
                                                class="tab-item <?php if ($_GET['item'] === 'Games') {
                                                    echo 'tab-item-selected';
                                                } ?>">Games</a>
                                            <a href="https://localhost/admi/?tab=Moderation&item=Library"
                                                class="tab-item <?php if ($_GET['item'] === 'Library') {
                                                    echo 'tab-item-selected';
                                                } ?>">Library</a>
                                            <a href="https://localhost/admi/?tab=Moderation&item=Reports"
                                                class="tab-item <?php if ($_GET['item'] === 'Reports') {
                                                    echo 'tab-item-selected';
                                                } ?>">Reports</a>
                                            <a href="https://localhost/admi/?tab=Moderation&item=Approval"
                                                class="tab-item <?php if ($_GET['item'] === 'Approval') {
                                                    echo 'tab-item-selected';
                                                } ?>">Item
                                                Approval</a>
                                            ...
                                            <td class="content-area ">
                                                ...
                                                <div class="items-container ">
                                                    ...
                                                    <form action="https://localhost/admi/?tab=Moderation&item=Users"
                                                        method="POST">
                                                        <table class="item-table">
                                                                                                                ...
                                                                                                                <div>
                                                                                                                    <div>
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            ...
                                                                                                                            Picture:</span>
                                                                                                                        <img src="<?php echo getUserThumbnail($con, $SearchedUser['id']); ?>"
                                                                    ...
                                                                    <table class="details-table">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td>
                                                                                    <div>
                                                                                        <form action="/admi/api/userban"
                                                                                            method="POST">
                                                                                            <div>
                                                                                                <br>
                                                                                                <span class="form-label">User
                                                                                                    ID:</span>
                                                                                                <span><?php echo $SearchedUser['id']; ?></span>
                                                                                                <input type="hidden" name="UserId"
                                                                                                    value="<?php echo $SearchedUser['id']; ?>">
                                                                                            </div>
                                                                                            <div>
                                                                                                <br>
                                                                                                <span class="form-label">Ban
                                                                                                    Type:</span>
                                                                                                <select
                                                                                                    class="form-select no-margins"
                                                                                                    name="Type">
                                                                                                    <option value="Revert">Revert
                                                                                                    </option>
                                            ...
                                            <tr>
                                                <td>
                                                    <div>
                                                        ...
                                                        <input name="search" type="text" class="text-box text-box-medium"
                                                            tabindex="1">
                                                    </div>
                                                    <div>
                                                        <br>
                            ...
                            <?php if ($_GET['item'] === "Games") { ?>
                                <td class="content-area ">
                                    ...
                                    <div class="items-container ">
                                        ...
                                        <form action="https://localhost/admi/api/gameban" method="POST">
                                            <table class="item-table">
                                                <td class="universe-name-col">
                                                    <a class="title">Ban</a>
                                                    <table class="details-table">
                                                                    ...
                                                                    <div>
                                                                        <div>
                                                                            ...
                                                                            <input name="GameId" type="text"
                                                                                class="text-box text-box-medium" tabindex="1">
                                                                        </div>
                                                                        <br>
                                                                        <label class="form-label" for="Version">Ban
                                                                            Type:</label>
                                                                        <select class="form-select no-margins" id="Type"
                                                                            name="Type">
                            ...
                            <?php if ($_GET['item'] === "Library") { ?>
                                <td class="content-area ">
                                    ...
                                    <div class="items-container ">
                                        ...
                                        <form action="https://localhost/admi/api/libraryban" method="POST">
                                            <table class="item-table">
                                                <td class="universe-name-col">
                                                    <a class="title">Ban</a>
                                                    <table class="details-table">
                                                                ...
                                                                <td>
                                                                    <div>
                                                                        <div>
                                                                            ...
                                                                            <input name="LibraryId" type="text"
                                                                                class="text-box text-box-medium" tabindex="1">
                                                                        </div>
                                                                        <br>
                                                                        <label class="form-label" for="Version">Ban
                ...
                <?php if ($_GET['item'] === "Approval") { ?>
                    <td class="content-area ">
                        ...
                        <div class="items-container ">
                            ...
                            while ($items = $itemquery->fetch()) {
                                ...
                                ?>
                                <form action="https://localhost/admi/api/approval" method="POST">
                                    <table class="item-table">
                                        <tbody>
                                            <tr>
                                                <td class="image-col" title="<?php echo NoXSSPlz($name); ?>" rowspan="3">
                                                    <a href="<?= $link; ?>" class="item-image ad-image">
                                                        <?php if ($items['type2'] == "Shirt" || $items['type2'] == "Pants" || $items['type2'] == "Decal" || $items['type2'] == "TShirt" || $items['type2'] == "Face") { ?><img
                                                                style="max-width:75px;max-height:75px;"
                                                                src="https://localhost/asset/?id=<?= $items['realfileid']; ?>" <?php } elseif ($items['type2'] == "Hat" || $items['type2'] == "Mesh" || $items['type2'] == "Gamepass" || $items['type2'] == "Badge") { ?><img
                                                                style="max-width:75px;max-height:75px;"
                                                                src="https://localhost/model-thumbnails?assetId=<?= $items['id']; ?>&bypassadminpanel=true"
                                                            <? } elseif ($items['type2'] == "Sound") { ?><audio style="max-width:250px;"
                                                                controls preload="none">
                                                            <source src="http://localhost/asset?id=<?= $items['realfileid']; ?>">
                                                            Your browser does not support the audio element.
                                                            </audio><? } elseif ($items['type2'] == "Video") { ?>
                                                            <video
                                                                src="https://localhost/asset/?id=<?= $items['realfileid']; ?>&adminpanel=true"
                                                                controls preload="none" class="item-image video-process"></video>
                                                        <? } ?>
                                                    </a>
                                                </td>
                                                <td class="universe-name-col">
                                                    <a class="title"
                                                        href="https://localhost/library/?id=<?= $itemid; ?>"><?php echo NoXSSPlz($name); ?></a>
                                                    <table class="details-table">
                                                        <tbody>
                                                            <tr>
                                                            ...
                                                            <td class="ad-activate-cell">
                                                                <a
                                                                    href="https://localhost/users/<?= $creatorid; ?>/profile"><?php echo NoXSSPlz($creatorname);
                                                                    if ($isflagged == 1) {
                                                                        echo '<h4 class="red-text">(!)</h4>';
                                                                    } ?></a>
                                                            </td>
                                                        </tbody>
                                                    </table>
                                                ...
                                                <td class="edit-col">
                                                    ...
                                                    <button class="btn-medium btn-primary" name="Approve" value="Approve"
                                                        style="background-color:#0eac14; border-color:#0eac14;width:125;">Approve</button>
                                                    <button class="btn-medium btn-primary" name="Unapprove" value="Unapprove"
                                                        style="background-color:#b52a2a; border-color:#b52a2a;">Unapprove</button>
                                                </td>
                                                <td class="menu-col">
                                                </td>
                                            </tr>
                                                ...
                                                <td class="image-col" title="<?php echo NoXSSPlz($name); ?>" rowspan="3">
                                                    <a href="<?= $link; ?>" class="item-image ad-image">
                                                        <img style="max-width:75px;max-height:75px;"
                                                            src="https://localhost/img/ads/<?= $image; ?>.png">
                                                </td>
                                                </a>
                        </td>
                        <td class="universe-name-col">
                            ...
                            <table class="details-table">
                                <tbody>
                                    ...
                                    <td class="ad-activate-cell">
                                        <a
                                            href="https://localhost/users/<?= $creatorid; ?>/profile"><?php echo NoXSSPlz($creatorname); ?></a>
                                    </td>
                                </tbody>
                            </table>
                        </td>
                    ...
                    while ($items = $itemquery->fetch()) {
                        ...
                        $type = $items['assetType'];
                        if ($type === "Game") {
                            $link = "https://localhost/games/" . $itemid . "/";
                        } else {
                            $link = "https://localhost/library/?id=" . $itemid . "";
                        }
                        ?>
                        <form action="https://localhost/admi/api/approval" method="POST">
                            <table class="item-table">
                                <tbody>
                                    <tr>
                                        <td class="image-col" title="<?php echo NoXSSPlz($name); ?>" rowspan="3">
                                            <a href="https://localhost/videos/<?= $image; ?>.mp4" class="item-image ad-image">
                                                <div class="overlay-play-button">
                                                    <video style="max-width:75px;max-height:75px;"
                                                        src="https://localhost/videos/<?= $image; ?>.mp4"></video>
                            ...
                            <form action="https://localhost/admi/api/approval" method="POST">
                                <table class="item-table">
                                    <tbody>
                                        <tr>
                                            <td class="image-col" title="<?php echo NoXSSPlz($name); ?>" rowspan="3">
                                                <a href="https://localhost/games/<?= $itemid; ?>" class="item-image ad-image">
                                                    <img style="max-width:75px;max-height:75px;"
                                                        src="https://localhost/place-thumbnails?placeId=<?= $items['id']; ?>&bypassadmin=true">
                                            </td>
                                            </a>
                                            </td>
                                            <td class="universe-name-col">
                                                <a class="title"
                                                    href="https://localhost/games/<?= $itemid; ?>"><?php echo NoXSSPlz($name); ?></a>
                                                <table class="details-table">
                                                    <tbody>
                                                        <tr>
                                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="image-col" title="<?php echo NoXSSPlz($name); ?>" rowspan="3">
                                                <a href="https://localhost/games/<?= $itemid; ?>" class="item-image ad-image">
                                                    <img style="max-width:75px;max-height:75px;"
                                                        src="https://localhost/place-thumbnails?placeId=<?= $items['id']; ?>&bypassadmin=true&type=2">
                                            </td>
                                            </a>
                                            </td>
                                            <td class="universe-name-col">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="image-col" title="<?php echo NoXSSPlz($name); ?>" rowspan="3">
                                                <a href="https://localhost/games/<?= $itemid; ?>" class="item-image ad-image">
                                                    <img style="max-width:75px;max-height:75px;"
                                                        src="https://localhost/place-thumbnails?placeId=<?= $items['id']; ?>&bypassadmin=true&type=3">
                                            </td>
                                            </a>
                                            </td>
                                            <td class="universe-name-col">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="image-col" title="<?php echo NoXSSPlz($name); ?>" rowspan="3">
                                            <a href="https://localhost/games/<?= $itemid; ?>" class="item-image ad-image">
                                                <img style="max-width:75px;max-height:75px;"
                                                    src="https://localhost/img/games/<?= $items['id']; ?>s.png">
                                        </td>
                                        </a>
                                        </td>
                                        <td class="universe-name-col">
        ...
        <div class="BuildPageContent" data-groupid="">
            <table id="build-page" data-asset-type-id="" data-edit-opens-studio="True">
                <tbody>
                    <tr>
                        <td class="menu-area divider-right">
                            <a href="https://localhost/admi/?tab=GameServers&item=GameJobs"
                                class="tab-item <?php if ($_GET['item'] === 'GameJobs') {
                                    echo 'tab-item-selected';
                                } ?>">Game
                                Jobs</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-secondary-xs"
                                                            onclick="location.replace('https://localhost/admi/api/closejob?jobId=<?= $jobId; ?>');">
                                                            Close
                                                        </div>
                                                    </td>
                                                </tr>
    ...
    <?php if ($_GET['tab'] === "WebsiteControl" && $SuperAdmin == 1) { ?>
        <div class="BuildPageContent" data-groupid="">
            <table id="build-page" data-asset-type-id="" data-edit-opens-studio="True">
                <tbody>
                    <tr>
                        <td class="menu-area divider-right">
                            <a href="https://localhost/admi/?tab=WebsiteControl&item=Alerts"
                                class="tab-item <?php if ($_GET['item'] === 'Alerts') {
                                    echo 'tab-item-selected';
                                } ?>">Alerts</a>
                            <a href="https://localhost/admi/?tab=WebsiteControl&item=Promocodes"
                                class="tab-item <?php if ($_GET['item'] === 'Promocodes') {
                                    echo 'tab-item-selected';
                                } ?>">Promocodes</a>
                            ...
                            <td class="content-area ">
                                ...
                                <h5>To remove an alert, leave the text box blank.</h6>
                                    <form action="https://localhost/admi/api/alert" method="POST">
                                        <table class="item-table">
                                            <td class="universe-name-col">
                                                <table class="details-table">
                                                    <tbody>
        ...
        <?php if ($_GET['item'] === "Promocodes") { ?>
            ...
            <td class="content-area ">
                ...
                <form action="https://localhost/admi/api/promocodes" method="POST">
                    <table class="item-table">
                        <td class="universe-name-col">
                            <table class="details-table">
                                <tbody>
            ...
            <div class="BuildPageContent" data-groupid="">
                <table id="build-page" data-asset-type-id="" data-edit-opens-studio="True">
                    <tbody>
                        <tr>
                            <td class="menu-area divider-right">
                                <a href="https://localhost/admi/?tab=Statistics&item=Users"
                                    class="tab-item <?php if ($_GET['item'] === 'Users') {
                                        echo 'tab-item-selected';
                                    } ?>">Users</a>
                                <?php if ($_GET['item'] === "Users") { ?>
        ...
        <script type='text/javascript' src='https://localhost/js/e20b65b5f3876e969af34b10d11a9b8d.js'></script>
        <script type='text/javascript' src='https://localhost/js/a3d0fc23f71b8d010b8bf64ed7d52da5.js'></script>
        <script
            type='text/javascript'>Roblox.config.externalResources = []; Roblox.config.paths['Pages.Catalog'] = 'https://localhost/js/165e89fea66b7c146c7a723c33ca7108.js'; Roblox.config.paths['Pages.CatalogShared'] = 'https://localhost/js/2c184f0c9c042d5309458c45dddf6d4e.js'; Roblox.config.paths['Widgets.AvatarImage'] = 'https://localhost/js/823c7d686e6b3d8321275740fe498f9d.js'; Roblox.config.paths['Widgets.DropdownMenu'] = 'https://localhost/js/5cf0eb71249768c86649bbf0c98591b0.js'; Roblox.config.paths['Widgets.GroupImage'] = 'https://localhost/js/556af22c86bce192fb12defcd4d2121c.js'; Roblox.config.paths['Widgets.HierarchicalDropdown'] = 'https://localhost/js/7689b2fd3f7467640cda2d19e5968409.js'; Roblox.config.paths['Widgets.ItemImage'] = 'https://localhost/js/8e3d1677fd9198849f05583bc0740555.js'; Roblox.config.paths['Widgets.PlaceImage'] = 'https://localhost/js/45d46dd8e2bd7f10c17b42f76795150d.js'; Roblox.config.paths['Widgets.SurveyModal'] = 'https://localhost/js/56ad7af86ee4f8bc82af94269ed50148.js';</script>
</body>